...
const focusColors: Record<FocusMode, string> = {
  recover: "border-rose-500/30 bg-rose-500/8",
  execute: "border-emerald-500/30 bg-emerald-500/8",
  focus: "border-sky-500/30 bg-sky-500/8",
  recalibrate: "border-amber-500/30 bg-amber-500/8",
  explore: "border-violet-500/30 bg-violet-500/8",
};
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider ${urgencyColors[level]}`}>
      <span className={`h-1.5 w-1.5 rounded-full ${
        ...
        level === "medium" ? "bg-sky-400" : "bg-slate-400"
      }`} />
      {meta.label}
    </span>
  );
  ...
  return (
    <div className={`flex items-start gap-3 rounded-xl border p-3 ${stepColors[i % 3]}`}>
      <span className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-[11px] font-bold ${
        ...
        i === 1 ? "bg-sky-500/20 text-sky-400" :
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-3">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-[10px] uppercase tracking-[0.2em] text-emerald-400 font-semibold">Opportunity</p>
        ...
        <div className="rounded-xl border border-rose-500/20 bg-rose-500/5 p-3">
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-[10px] uppercase tracking-[0.2em] text-rose-400 font-semibold">Risk</p>
        ...
        <div className="mt-4">
          ...
          <div className="space-y-2">
            {contradictions.map((c, i) => (
              <div key={`con-${i}`} className="flex items-start gap-2 rounded-xl border border-amber-500/20 bg-amber-500/5 p-3">
